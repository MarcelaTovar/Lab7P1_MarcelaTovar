...
public class Lab7P1_MarcelaTovar {
    ...
    public static void Calamar(){
        ...
        if(Validacion(opcion)&&Validacion(opcion2)&&Validacion(opcion3)&&Validacion(opcion4)&&Validacion(opcion5)&&Validacion(opcion6)&&Validacion(opcion7)&&Validacion(opcion8)){
           ...
           String minuscula3 = opcion2.toLowerCase();
           String minuscula4 = opcion2.toLowerCase();
           String minuscula5 = opcion2.toLowerCase();
           String minuscula6 = opcion2.toLowerCase();
           String minuscula7 = opcion2.toLowerCase();
           String minuscula8 = opcion2.toLowerCase();
           Pais(minuscula);
              System.out.println("-------------------------------------");
           Pais(minuscula2);
           Pais(minuscula3);
